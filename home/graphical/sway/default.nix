  ...
  wayland.windowManager.sway = {
    ...
    config = {
      ...
      keybindings = lib.mkOptionDefault {
        ...
        "XF86Sleep" = "exec ${pkgs.systemd}/bin/systemctl sleep";
        "XF86PowerOff" = "exec ${pkgs.systemd}/bin/systemctl sleep";
    ...
    extraConfig = ''
      bindswitch --reload --locked lid:on exec '${pkgs.swaylock-effects}/bin/swaylock && ${pkgs.systemd}/bin/systemctl sleep'
    '';
